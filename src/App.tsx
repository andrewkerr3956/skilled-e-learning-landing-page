      ...
      <main>
        <section id="hero-section" className="mt-[38px] md:mt-[125px] pb-[66px] md:pb-[226px]">
          <div className="container">
            ...
            <picture className="relative h-auto w-11/12 md:w-[640px] lg:w-[815px] xl:w-[990px] md:absolute md:-top-8 lg:-top-28 xl:-top-44 md:-right-[250px] lg:-right-[360px] xl:-right-[300px]">
        ...
        <section id="testimonials-section" className="pt-[24px] pb-[140px] bg-gradient-to-b from-white/0 to-[#F0F1FF]">
          <div className="container">
            <div className="mx-auto grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-x-0 md:gap-x-[11px] lg:gap-x-[30px] gap-y-[55px]">
