      ...
      <main>
        <section id="hero-section" className="mt-[38px] md:mt-[125px] pb-[66px] md:pb-[226px]">
          <div className="container">
            ...
            <picture className="relative h-auto w-11/12 md:w-[640px] lg:w-[815px] xl:w-[990px] md:absolute md:-top-8 md:-right-[250px] xl:-top-44 lg:-right-[360px] xl:-right-[375px]">
