...
const Card = (props: IProps) => {
    ...
    return (
        <figure className={`card ${!body ? "popular-card" : null} relative h-[322px] bg-white mx-auto md:mx-none`}>
            ...
            <figcaption className={`relative rounded-[10px] md:rounded-[15px] h-full pt-[64px] pb-[40px] px-[32px] bg-${gradientBg ? "orange-gradient" : "white"}`}>
